...
const LoanManager = ({
  ...
  const propertyLoans = useMemo(
    () =>
      propertyId
        ? safeLoans.filter((l) => l && l.property_id === propertyId)
        : safeLoans,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (onSaveData) {
        const actionDescription = editingLoan
  ...
  const getPropertyLoanStats = (propLoans) => {
    const totalAmount = propLoans.reduce(
      (sum, loan) => sum + (loan.currentBalance || loan.amount),
      0
    );
    const totalMonthly = propLoans.reduce(
    ...
    >
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        ...
        <div>
          ...
          <p className="text-white font-medium">
            {formatCurrency(loan.currentBalance || loan.amount)}
          </p>
        </div>
        <div>
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-400 mt-1">
            {propertyId
              ? "Manage loans for this property"
              : "Manage all property loans"}
          </p>
        </div>
        {canPerformActions && (
          <button
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className={`form-input ${
                      errors.termYears ? "border-red-500" : ""
                    }`}
                    placeholder="30"
                    min="1"
                  />
      ...
      <div className="space-y-4">
        {propertyId ? (
          ...
          propertyLoans.length === 0 ? (
            ...
            <div className="space-y-4">{propertyLoans.map(renderLoanCard)}</div>
          )
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="text-left">
                      ...
                      <div className="flex items-center space-x-4 text-sm text-gray-400">
                        <span>
                          {stats.active}/{stats.total} loans
                        </span>
